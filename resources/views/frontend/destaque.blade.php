			...
			<div class="row">				<article class="col-md-4 hestia-blog-item">
					<div class="card card-plain card-blog">
								...
								<a href="" title="{{ $destaque->titulo }}">
									<img width="100" height="80" src="{{ asset($destaque->imagem) }}" class="attachment-hestia-blog size-hestia-blog wp-post-image" alt="" </a>
							</div>
												<div class="content">
                ...
                {{ $destaque->titulo }}							</a>
							...
							<p class="card-description">{{ $destaque->texto }}</p>
						</div>
					</div>
				</article>
